            ...
            filtersOption =
                <div className='filtersOption'>
                    ...
                    <div className='checkboxfilter'>
                        ...
                        <input type="checkbox" name="hideMembers" checked={this.props.hideMembers} onChange = {this.props.handleFilter} />
                    </div>
                    <div className='checkboxfilter'>
                        <label>{ t('Partners') }</label>
                        <input type="checkbox" name="hidePartners" checked={this.props.hidePartners} onChange = {this.props.handleFilter} />
                    </div>
            ...
            filtersOption =
                <div className='filtersOption'>
                    ...
                    <div className='checkboxfilter'>
                        ...
                        <input type="checkbox" name={t('hideInactive')} checked={this.props.hideInactive} onChange = {this.props.handleFilter} />
                    </div>
                    <div className='textFilter'>
                        <input type="text" name="textFilter" placeholder={t('Search')} onChange = {this.props.handleFilter} />
                    </div>
